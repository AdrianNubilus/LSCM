<!--  /templates/skin/synio/blog_list.tpl  -->
		...
		<thead>
			<tr>
				...
				<th class="cell-name cell-tab">
					<div class="cell-tab-inner {if $sBlogOrder=='blog_title'}active{/if}"><a href="{$sBlogsRootPage}?order=blog_title&order_way={if $sBlogOrder=='blog_title'}{$sBlogOrderWayNext}{else}{$sBlogOrderWay}{/if}" {if $sBlogOrder=='blog_title'}class="{$sBlogOrderWay}"{/if} rel="nofollow"><span>{$aLang.blogs_title}</span></a></div>
				</th>
				...
				<th class="cell-rating cell-tab align-center">
					...
					<a href="{$sBlogsRootPage}?order=blog_rating&order_way={if $sBlogOrder=='blog_rating'}{$sBlogOrderWayNext}{else}{$sBlogOrderWay}{/if}" {if $sBlogOrder=='blog_rating'}class="{$sBlogOrderWay}"{/if} rel="nofollow"><span>{$aLang.blogs_rating}</span></a>
